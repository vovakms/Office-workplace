...
fix all; 
select
ID                                  ,//dword surrogate,// Идентификатор записи
char(rtrim(INN, 'C'), 12) as 'ИНН' ,// array(6) key  ,// ИНН юр.лица
